...
for file in file_paths:
    ...
    matchup_data = matchup_data[relevant_features]

    # Encode categorical columns (players and teams) using LabelEncoder
    label_encoders = {}
    for col in ["home_0", "home_1", "home_2", "home_3", "home_4", "away_0", "away_1", "away_2", "away_3", "away_4", "home_team", "away_team"]:
        le = LabelEncoder()
